...
const pro_israel_vc_url = process.env.GVCURL || "https://docs.google.com/document/d/e/2PACX-1vTc_OIs8MSVxqz0To2diHiDd_UIQBg_wBHLnmIQNtoTRQaFrC2ZcUWiOqR7dHMe2KnfnU-Bi7n-1XpW/pub"

async function checkProIsraelVcList() {
    const response = await fetch(pro_israel_vc_url);
